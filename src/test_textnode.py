...
class TestTextNodeToHTMLNode(unittest.TestCase):
    ...
    def test_split(self):
        ...
        blocks = split_nodes_delimiter([node], '`', TextType.CODE)
        self.assertEqual(blocks, [TextNode("This is text with a ", TextType.TEXT, None), TextNode("code block", TextType.CODE, None)])
